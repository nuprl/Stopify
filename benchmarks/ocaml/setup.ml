...
(* OASIS_START *)
(* DO NOT EDIT (digest: 98f30b5a77815ff460b8cce76ab2283e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          bugreports = None;
          synopsis =
            "OCaml operf-micro benchmarks modified to run easily under\nbucklescript+node";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "almabench.ml"});
               Executable
                 ({
                     cs_name = "boyer";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "boyer.ml"})
            ];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "×¼\158úcß\007\011\000_(£üqúJ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
